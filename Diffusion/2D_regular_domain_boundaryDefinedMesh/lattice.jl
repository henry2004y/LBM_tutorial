...
export Lattice,LatticeD2Q9,LatticeD2Q4,LatticeD2Q5, opp_lat_vec
...
struct LatticeD2Q9 <: Lattice
  ...
  function LatticeD2Q9(dx::AbstractFloat, dt::AbstractFloat,
                       mesh::Mesh,rho::AbstractFloat=0.0)
    ...
    new(dx, dt, cf(dx, dt), csf(dx, dt), cssqf(dx, dt), f, cdef, wdef, nw, nN)
  end
...
struct LatticeD2Q5 <: Lattice
  ...
  function LatticeD2Q5(dx::AbstractFloat, dt::AbstractFloat,
                       mesh::Mesh, rho::Float64=0.0)
    # Default lattice speed vectors and associated weights
...
elseif k == 4
  return 3
    ...
    error("$k > 4 for a D2Q4 lattice. Only four vectors (1-4) possible")
end
